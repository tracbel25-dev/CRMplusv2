...
export function LeanZeusJobDetail({ w, recordId }: { w: Workspace; recordId: string }) {
  ...
  const reportReady = operation.actionVisible('report') && (!active || !!job.diagnosis.trim() || ['Orçamento', 'Execução', 'Conferência', 'Entrega'].includes(job.stage));
