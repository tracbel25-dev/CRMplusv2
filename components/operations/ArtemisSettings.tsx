...
export function ArtemisSettings({ w }: { w: Workspace }) {
  ...
  return <>
    ...
    <Section title="De onde chegam seus pedidos?">
    ...
    <Section title="Como a equipe opera?">
      <div className="op-config-groups"><div className="op-config-group">
    ...
    <Section title="O que aparece no cardápio?">
      <div className="op-config-groups"><div className="op-config-group">
    ...
    <div className="op-form-footer"><Button onClick={save}>Salvar configurações</Button>{saved && <Badge>Salvo</Badge>}</div>
  </>;
}
