...
export function TeamAccess(){
  ...
  const submitInvite=async(event:FormEvent)=>{
    ...
    const selected=contracted.flatMap(app=>{const choice=inviteApps[app.slug];return choice?.access?[{appId:app.slug as AppId,canConfigure:choice.configure}]:[];});
